            ...
            function(){
                ...
                switch((player.discoveredBees.length>24?rand()*8:rand()*7+1)|0){
                    ...
                    case 0:
                        ...
                        player.addQuest('Keep Calm and Eat Chicken',[['mondoChick',1],['biscuitTokens',3],['biscuit',5]],'polarBear')
                        rew.push(['biscuit',5])
