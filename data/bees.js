...
// Note: 'objects' and 'player' usually represent the live game state.
// You may need to reference them via a global state manager
// or ensure they are available in the scope where beeInfo is used.

export const beeInfo = {
  basic: {
    u: 0,
    v: 0,
    meshPartId: 0,
